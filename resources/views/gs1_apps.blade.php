        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col text-end">
                    <a class="navbar-brand" href="#"><img src="{{asset('uploads/Picture3.png')}}" alt="Logo"></a>
                    <!-- Logo on the right -->
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                ...
                <a href="destination.html" class="card text-decoration-none">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset('uploads/grocery.png')}}" class="img-fluid rounded-start h-100 card-img"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4 mx-auto">
                ...
                <a href="destination.html" class="card text-decoration-none">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset('uploads/medicine.png')}}" class="img-fluid rounded-start h-100 card-img"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4 mx-auto">
                ...
                <a href="destination.html" class="card text-decoration-none">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset('uploads/retail_pos.png')}}" class="img-fluid rounded-start h-100 card-img"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
        ...
        <div class="row mt-2">
            <div class="col-md-4 mx-auto">
                ...
                <a href="destination.html" class="card text-decoration-none">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset('uploads/cafe.png')}}" class="img-fluid rounded-start h-100 card-img"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4 mx-auto">
                ...
                <a href="destination.html" class="card text-decoration-none">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset('uploads/restaurant.png')}}" class="img-fluid rounded-start h-100 card-img"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4 mx-auto">
                ...
                <a href="destination.html" class="card text-decoration-none">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset('uploads/pump-pos.png')}}" class="img-fluid rounded-start h-100 card-img"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
